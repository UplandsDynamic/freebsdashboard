...
class ZfsFileSystems(models.Model):
	...
	compression = models.BooleanField(default=True, null=False)
	quota = models.IntegerField(default=0, null=False)
	sharenfs = models.BooleanField(default=False, null=False)
...
class TaskManager(models.Model):
	...
	snapshots = models.TextField(null=True)
